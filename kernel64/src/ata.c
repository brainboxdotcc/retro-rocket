...
uint8_t ide_ata_access(uint8_t direction, uint8_t drive, uint64_t lba, uint8_t numsects, uint64_t edi)
{
...
uint8_t ide_atapi_read(uint8_t drive, uint64_t lba, uint8_t numsects, uint64_t edi)
{
